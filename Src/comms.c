...
const parameter_entry params[] = {
  ...
  // Type       ,Name                 ,Datatype, ValueL ptr                  ,ValueR                    ,EEPRM Addr ,Init              Int/Ext ,Min    ,Max    ,Div             ,Mul  ,Fix   ,Callback Function  ,Help text
    ...
    {VARIABLE   ,"SPDL_RAW"           ,ADD_PARAM(rtY_Left.n_mot_raw)         ,NULL                      ,0          ,0                 ,0      ,0      ,0      ,0               ,0    ,0     ,NULL               ,"Left Motor Measured RPM raw"},
    {VARIABLE   ,"SPDR_RAW"           ,ADD_PARAM(rtY_Right.n_mot_raw)        ,NULL                      ,0          ,0                 ,0      ,0      ,0      ,0               ,0    ,0     ,NULL               ,"Right Motor Measured RPM raw"},
    {VARIABLE   ,"ADC_TX2_RAW"        ,ADD_PARAM(adc_buffer.l_tx2)            ,NULL                      ,0          ,0                 ,0      ,0      ,4095   ,0               ,0    ,0     ,NULL               ,"ADC2 PA2 raw value"},
    {VARIABLE   ,"ADC_RX2_RAW"        ,ADD_PARAM(adc_buffer.l_rx2)            ,NULL                      ,0          ,0                 ,0      ,0      ,4095   ,0               ,0    ,0     ,NULL               ,"ADC2 PA3 raw value"},
    {VARIABLE   ,"ANGLEL_RAW"         ,ADD_PARAM(rtY_Left.a_elecAngle_raw)   ,NULL                      ,0          ,0                 ,0      ,0      ,0      ,0               ,0    ,0     ,NULL               ,"Left Motor ElecAngle raw"},
    {VARIABLE   ,"ANGLER_RAW"         ,ADD_PARAM(rtY_Right.a_elecAngle_raw)  ,NULL                      ,0          ,0                 ,0      ,0      ,0      ,0               ,0    ,0     ,NULL               ,"Right Motor ElecAngle raw"},
