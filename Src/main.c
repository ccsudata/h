...
int main(void) {
  ...
  /* Keep the board on the internal HSI clock path during startup.
     Do not re-run the PLL/HSE clock configuration here. */
  /* SystemClock_Config(); */
...
void SystemClock_Config(void) {
  ...
  /* Force the board to stay on the internal HSI clock path.
     This avoids any PLL/HSE reconfiguration during startup. */
