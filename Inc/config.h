...
#define DUAL_INPUTS
#define PRI_INPUT1  2,  800, 1095, 3200, 80
/* ==================================================================
 * PRI_INPUT2  – 刹车踏板 (对应 l_tx2 ADC 通道)
 * 类型:   2 (双向输入，中位有效)
 * 最小值: 800   (物理行程最小 ADC)
 * 中位值: 1035  (完全松开时实际测得的 ADC，此值映射为命令 0)
 * 最大值: 3125  (物理行程最大 ADC)
 * 死区:   50    (中位附近 ±50 ADC 均视为 0)
 *
 * 注意: 确保死区覆盖刹车踏板在释放状态的微小漂移，
 *       否则可能被误判为轻微制动。
 * ================================================================== */
#define PRI_INPUT2  2,  800, 1035, 3125, 50
