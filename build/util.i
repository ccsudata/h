...
InputStruct input1[2] = { {0, 0, 0, 2, 800, 1095, 3200, 80}, {0, 0, 0, 2, -1000, 0, 1000, 0} };
InputStruct input2[2] = { {0, 0, 0, 2, 800, 1035, 3125, 50}, {0, 0, 0, 2, -1000, 0, 1000, 0} };
...
# 1051 "Src/util.c"
    if (timeoutFlgSerial) {
        if (timeoutFlgADC || timeoutFlgGen) {
    ...
    } else if (serialCmdActive_R) {

        ctrlModReq = ctrlModReqRaw;
    } else if (timeoutFlgADC || timeoutFlgGen) {
